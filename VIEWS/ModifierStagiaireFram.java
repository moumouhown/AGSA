...
public class ModifierStagiaireFram extends javax.swing.JDialog {

       GestionStagiaireFram gestionStagiaireFram;
       Connection connection;
       String ID_STAGIAIRE;
      
    public ModifierStagiaireFram(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public ModifierStagiaireFram(java.awt.Frame parent, boolean modal,GestionStagiaireFram gestionStagiaireFram, Connection connection,
        String ID_STAGIAIRE          
       ) {
            ...
            try
        {
            ...
            ResultSet rs = statement.executeQuery("select * from ApprentiStagiaire where IDAS = '"+ID_STAGIAIRE+"'");
            ...
            while(rs.next()){
                ...
                this.jTextArea1.setText(rs.getString(5));
                this.jTextField8.setText(rs.getString(6));
                this.jFormattedTextField1.setText(rs.getString(7));
                this.jTextField5.setText(rs.getString(8));
                this.jTextField9.setText(rs.getString(9));
       ...
       public void  ModifierStagiaire()
      {
            ...
            String date_naiss="'"+ this.jFormattedTextField1.getText()+"'";
            String lieu_naiss="'"+ this.jTextField5.getText()+"'";
        ...
        {
            Statement statement = this.connection.createStatement();
            ResultSet rs = statement.executeQuery("update ApprentiStagiaire set nom ="+nom+", prenom ="+prenom+","
                    + " NUMTEL="+num_tel+", ADRESSE="+adresse+", EMAIL="+email+" ,"
                    + " DATENAISS="+date_naiss+", LIEUNAISS="+lieu_naiss+","
                    + " NIVEAUSCOLAIRE="+niveau_scolaire+", NUMCCP="+null+" where IDAS = '"+ID_STAGIAIRE+"'");
        
              JOptionPane.showMessageDialog(null , "Stagiaire avec l'ID: "+this.ID_STAGIAIRE+" a été bien modifié dans la base de données", "Information", JOptionPane.INFORMATION_MESSAGE);   
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/RESSOURCES/353430_checkbox_pen_edit_pencil_icon.png"))); // NOI18N
        jLabel1.setText("Modifier stagiaire");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifierStagiaireFram.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ModifierStagiaireFram dialog = new ModifierStagiaireFram(new javax.swing.JFrame(), true);
