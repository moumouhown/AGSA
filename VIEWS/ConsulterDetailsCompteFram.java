...
public class ConsulterDetailsCompteFram extends javax.swing.JPanel {
 
    Connection connection;
    GestionComptesFram gestionComptesFram;
    String ID_UTILISATEUR;
 
    public ConsulterDetailsCompteFram(Connection connection,GestionComptesFram gestionComptesFram, String ID_UTILISATEUR) {
        initComponents();
            ...
            try
        {
            ...
            while(rs.next()){
                ...
                this.jTextField10.setText(rs.getString(4));
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Voici les informations détailées de l'utilisateur:");
