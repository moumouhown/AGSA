...
public class AjouterCompte extends javax.swing.JPanel {
 
    Connection connection;
    GestionComptesFram gestionComptesFram;
 
    public AjouterCompte(Connection connection,GestionComptesFram gestionComptesFram) {
        initComponents();
    ...
    public void EnregistrerCompte() {
        String ID_UTILISATEUR = "'" + this.jTextField1.getText() + "'";
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("insert into Utilisateur values(" + ID_UTILISATEUR + ","
                    + "" + ID_EMPLOYE + ","
                    + "" + MDP + ","
                    + "" + TYPE + ","
                    + "" + NOM + ","
